...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Canvas, [{
    ...
    value: function componentDidUpdate() {
      ...
      ctx.clearRect(0, 0, ctx.width, ctx.height); // ctx.beginPath();
    ...
    value: function componentDidMount() {
      ...
      var canvas = this.refs.canvas;
      var ctx = canvas.getContext("2d");
      ctx.font = "40px Courier black"; // ctx.fillRect(coords[0][0], coords[0][1], coords[1][0], coords[1][1])
...
//# sourceMappingURL=index.js.9fda903b0f42aa0f5ba9.hot-update.js.map
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(CoordinatesForm, [{
    ...
    value: function handleChange(event) {
      ...
      this.setState(Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, name, _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(event.target.value)));
      console.log('set new state!!!!!!!!!!!!!!');
      console.log(this.state);
      this.postData.name = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_1___default()(event.target.value); // this.postData = {
      //   "geometries": [
...
//# sourceMappingURL=index.js.f96e68709cb4258fea58.hot-update.js.map
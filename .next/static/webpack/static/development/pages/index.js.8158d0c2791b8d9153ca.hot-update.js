...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Canvas, [{
    ...
    value: function componentDidMount() {
      ...
      var coords = JSON.parse(rawCoordinates).geometries;
      var canvas = this.refs.canvas;
      var ctx = canvas.getContext("2d");
      ctx.font = "40px Courier"; // ctx.fillRect(coords[0][0], coords[0][1], coords[1][0], coords[1][1])

      console.log(rawCoordinates);
      console.log(coords);
      ctx.beginPath();
      coords.map(function (c, index) {
        ctx.lineTo(c[index][0], c[index][1]);
        ctx.stroke();
      });
    }
  }, {
...
//# sourceMappingURL=index.js.8158d0c2791b8d9153ca.hot-update.js.map
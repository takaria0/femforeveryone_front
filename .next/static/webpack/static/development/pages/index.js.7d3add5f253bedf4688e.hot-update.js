...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(CoordinatesForm, [{
    ...
    value: function handleChange(event) {
      ...
      this.setState(Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, name, event.target.value));
      console.log('set new state!!!!!!!!!!!!!!');
      console.log(this.state); // this.postData = {
      //   "geometries": [
...
//# sourceMappingURL=index.js.7d3add5f253bedf4688e.hot-update.js.map